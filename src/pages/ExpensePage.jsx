    ...
    <div>
      ...
      <details className="filter-collapsible mb-4" open>
        <summary>
          ...
          Filters
          <span className="ml-auto text-xs font-semibold text-gray-500">{filtered.length} records</span>
        </summary>
      ...
      {timelineTarget && <TimelineModal record={timelineTarget} module={WORKFLOW_MODULES[type]} onClose={() => setTimelineTarget(null)} />}
      {detailTarget && (
        <RecordDrawer
          title={config.title}
          subtitle={detailTarget.uniq_id}
          record={detailTarget}
          fields={[
