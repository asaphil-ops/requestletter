-- Restores read access for the portal's custom-login client.
...
-- Supabase Auth should replace these broad read policies with role-based policies.
...
where schemaname = 'public'
  and policyname like 'portal_read_%'
order by tablename;
